...
var Dosa_TruncateScope_Helper = struct {
	Args           func(request *TruncateScopeRequest) *Dosa_TruncateScope_Args
...
func init() {
	Dosa_TruncateScope_Helper.Args = func(request *TruncateScopeRequest) *Dosa_TruncateScope_Args {
		return &Dosa_TruncateScope_Args{Request: request}
	}

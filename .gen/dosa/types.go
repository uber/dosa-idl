...
type CheckSchemaOp int32

const (
	CheckSchemaOpAlreadyRegistered CheckSchemaOp = 0
	CheckSchemaOpToUpsert          CheckSchemaOp = 1
)

// CheckSchemaOp_Values returns all recognized values of CheckSchemaOp.
func CheckSchemaOp_Values() []CheckSchemaOp {
	return []CheckSchemaOp{
		CheckSchemaOpAlreadyRegistered,
		CheckSchemaOpToUpsert,
	}
}

// UnmarshalText tries to decode CheckSchemaOp from a byte slice
// containing its name.
//
//   var v CheckSchemaOp
//   err := v.UnmarshalText([]byte("ALREADY_REGISTERED"))
func (v *CheckSchemaOp) UnmarshalText(value []byte) error {
	switch string(value) {
	case "ALREADY_REGISTERED":
		*v = CheckSchemaOpAlreadyRegistered
		return nil
	case "TO_UPSERT":
		*v = CheckSchemaOpToUpsert
		return nil
	default:
		return fmt.Errorf("unknown enum value %q for %q", value, "CheckSchemaOp")
	}
}

// ToWire translates CheckSchemaOp into a Thrift-level intermediate
// representation. This intermediate representation may be serialized
// into bytes using a ThriftRW protocol implementation.
//
// Enums are represented as 32-bit integers over the wire.
func (v CheckSchemaOp) ToWire() (wire.Value, error) {
	return wire.NewValueI32(int32(v)), nil
}

// FromWire deserializes CheckSchemaOp from its Thrift-level
// representation.
//
//   x, err := binaryProtocol.Decode(reader, wire.TI32)
//   if err != nil {
//     return CheckSchemaOp(0), err
//   }
//
//   var v CheckSchemaOp
//   if err := v.FromWire(x); err != nil {
...
//   }
//   return v, nil
func (v *CheckSchemaOp) FromWire(w wire.Value) error {
	*v = (CheckSchemaOp)(w.GetI32())
	return nil
}

// String returns a readable string representation of CheckSchemaOp.
func (v CheckSchemaOp) String() string {
	w := int32(v)
	switch w {
	case 0:
	...
	return fmt.Sprintf("CheckSchemaOp(%d)", w)
}

// Equals returns true if this CheckSchemaOp value matches the provided
// value.
func (v CheckSchemaOp) Equals(rhs CheckSchemaOp) bool {
	return v == rhs
}

// MarshalJSON serializes CheckSchemaOp into JSON.
//
// If the enum value is recognized, its name is returned. Otherwise,
// its integer value is returned.
//
// This implements json.Marshaler.
func (v CheckSchemaOp) MarshalJSON() ([]byte, error) {
	switch int32(v) {
	case 0:
		return ([]byte)("\"ALREADY_REGISTERED\""), nil
	case 1:
		return ([]byte)("\"TO_UPSERT\""), nil
	}
	return ([]byte)(strconv.FormatInt(int64(v), 10)), nil
}

// UnmarshalJSON attempts to decode CheckSchemaOp from its JSON
// representation.
//
...
func (v *CheckSchemaOp) UnmarshalJSON(text []byte) error {
	...
	case json.Number:
		...
		if x > math.MaxInt32 {
			return fmt.Errorf("enum overflow from JSON %q for %q", text, "CheckSchemaOp")
		}
		if x < math.MinInt32 {
			return fmt.Errorf("enum underflow from JSON %q for %q", text, "CheckSchemaOp")
		}
		*v = (CheckSchemaOp)(x)
		return nil
	case string:
	...
	default:
		return fmt.Errorf("invalid JSON value %q (%T) to unmarshal into %q", t, t, "CheckSchemaOp")
	}
}
...
type CheckSchemaRequest struct {
	...
	Op         *CheckSchemaOp      `json:"op,omitempty"`
}
...
func _CheckSchemaOp_Read(w wire.Value) (CheckSchemaOp, error) {
	var v CheckSchemaOp
	err := v.FromWire(w)
	return v, err
}
...
func (v *CheckSchemaRequest) FromWire(w wire.Value) error {
	...
	for _, field := range w.GetStruct().Fields {
		...
		case 4:
			if field.Value.Type() == wire.TI32 {
				var x CheckSchemaOp
				x, err = _CheckSchemaOp_Read(field.Value)
				v.Op = &x
				if err != nil {
					return err
				}
...
func _CheckSchemaOp_EqualsPtr(lhs, rhs *CheckSchemaOp) bool {
	if lhs != nil && rhs != nil {
...
func (v *CheckSchemaRequest) Equals(rhs *CheckSchemaRequest) bool {
	...
	if !_CheckSchemaOp_EqualsPtr(v.Op, rhs.Op) {
		return false
	}
...
// zero value if it is unset.
func (v *CheckSchemaRequest) GetOp() (o CheckSchemaOp) {
	if v.Op != nil {
		return *v.Op
	}

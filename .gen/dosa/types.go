...
func ElemType_Values() []ElemType {
	return []ElemType{ElemTypeBool, ElemTypeBlob, ElemTypeString, ElemTypeInt32, ElemTypeInt64, ElemTypeDouble, ElemTypeTimestamp, ElemTypeUUID, ElemTypeReserved0, ElemTypeReserved1, ElemTypeReserved2, ElemTypeReserved3}
}
...
func Operator_Values() []Operator {
	return []Operator{OperatorEq, OperatorLt, OperatorGt, OperatorLtOrEq, OperatorGtOrEq}
}
